...
namespace TimeForge.Infrastructure.Migrations
{
    ...
    [Migration("20250906175512_Added UserConnection table to database")]
    partial class AddedUserConnectiontabletodatabase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeForge.Models.TaskItem", b =>
                {
                    ...
                    b.Property<string>("TaskCollectionId")
                        .IsRequired()
                        .HasColumnType("nvarchar(40)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TimeForge.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TimeForge.Models.Project", b =>
                {
                    b.HasOne("TimeForge.Models.User", "AssignedTo")
            ...
            modelBuilder.Entity("TimeForge.Models.TaskCollection", b =>
                {
                    b.HasOne("TimeForge.Models.User", "User")
                        .WithMany("TaskCollections")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("TimeForge.Models.TaskItem", b =>
                {
                    b.HasOne("TimeForge.Models.TaskCollection", "TaskCollection")
                        .WithMany("TaskItems")
            ...
            modelBuilder.Entity("TimeForge.Models.User", b =>
                {
                    b.HasOne("TimeForge.Models.User", "Manager")
